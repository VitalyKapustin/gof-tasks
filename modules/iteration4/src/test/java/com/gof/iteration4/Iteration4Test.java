...
public class Iteration4Test {
    ...
    public void testLiveDataStrategy() {
        ...
        Assert.assertEquals("test1test1test1", dataStrategyContext.executeStrategy("test0test0test0"));
    }
    ...
    public void testPreparedDataStrategy() {
        ...
        Assert.assertEquals("test358test358test358", dataStrategyContext.executeStrategy("test0test0test0"));
    }

    @Test
    public void testFakeDataStrategy() {
        DataStrategyContext dataStrategyContext = new DataStrategyContext(new FakeDataStrategy());
        Assert.assertEquals("test#test#test#", dataStrategyContext.executeStrategy("test0test0test0"));
    }

    @Test
    public void testErrDataStrategy() {
        DataStrategyContext dataStrategyContext = new DataStrategyContext(new ErrDataStrategy());
        Assert.assertEquals("testERtestERtestER", dataStrategyContext.executeStrategy("test0test0test0"));
    }
}